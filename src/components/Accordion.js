...
export default function Accordion({
    ...
    const scrollImagesLeft = (index) => {
      const container = document.getElementById(`scrollable-images-${index}`);
      ...
      <div className="accordion-item mt-2" key={item.id}>
            ...
            <div className="d-flex align-items-center justify-content-between w-100">
              <div>
                ...
                <div>
                  ...
                  <span className="fw-bold Event-category fs-6 ml-2">
                    {item.category}
                  </span>
                </div>
              </div>
        ...
        >
          <div className="accordion-body">
            ...
            <div className="row">
              {/* Left Side: Scrollable Image Container */}
              <div className="col-lg-6">
                <div className="scroll-container">
                  ...
                  <div
                    ...
                    id={`scrollable-images-${index}`}
                  >
                    {item.images.map((imgUrl, imgIndex) => (
                      <img key={imgIndex} className="img-fluid" src={imgUrl} alt={`Event Image ${imgIndex}`} />
                    ))}
                  </div>
                  <button
              ...
              <div className="col-lg-6 mt-3">
                ...
                <ul className="list-unstyled">
                  ...
                  <li
                    className="fw-bold"
                    style={{ color: "#3d69ad", fontSize: "1.2rem" }}
                  >
                    <span className="fw-normal text-dark">Partner:</span>{" "}
                    {item.partner}
                  </li>
                  <li>
                    {item.date},{" "}
